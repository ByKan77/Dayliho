document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function(info, successCallback, failureCallback) {
            fetch('http://192.168.30.10:1234/video/getVideos')
                .then(response => {
                    if (!response.ok) {
...
axios.get("http://192.168.30.10:1234/video/getVideos")
    .then(response => {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    submitBtn.addEventListener("click", async function(event) {
        ...
        try {
            ...
            const response = await axios.get(`http://192.168.30.10:1234/user/getUserById?id=${localStorage.getItem("userId")}`);
            ...
            if (response.data) {
                ...
                try {
                    const axiosResponse = await axios.post('http://192.168.30.10:1234/video/addSeance', formData, {
                        headers: {
