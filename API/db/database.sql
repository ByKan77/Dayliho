...
CREATE TABLE `seance` (
  ...
  CONSTRAINT `seanceDeSport_utilisateur0_FK` FOREIGN KEY (`id_utilisateur`) 
...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `participant_utilisateur0_FK` FOREIGN KEY (`id_utilisateur`) 
    REFERENCES `utilisateur` (`id`) ON DELETE CASCADE,
  CONSTRAINT `participant_seanceDeSport_FK` FOREIGN KEY (`id_seance`) 
